...
public class RedBlackTree<T extends Comparable<T>> implements OrderedSet<T> {
    /*
    ...
    public boolean remove(T element) {
        int nodesCountBeforeDeletion = nodesCount;
        delete(element);
        return nodesCountBeforeDeletion != nodesCount;
    }
    ...
    public Iterator<T> iterator() {
        ...
        Consumer<T> consumer = element -> result.add(element);
        eachInOrder(consumer);
