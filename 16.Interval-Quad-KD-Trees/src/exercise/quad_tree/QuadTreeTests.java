...
public class QuadTreeTests {
    ...
    public void TestMethod3() {
        ...
        index = 0;
        for (TestBox testBox : items.get(2)) { //TODO first textBox in this collection is with rectangle "10..0, 20..10" which CAN'T be in third quadrant. Skeleton test is busted!
