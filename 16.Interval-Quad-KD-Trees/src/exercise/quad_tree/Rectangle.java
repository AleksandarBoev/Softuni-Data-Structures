...
/*
    Note: skeleton logic here is built on a weird coordinate system.
    Instead of the classic "L" where to the right means bigger X and up means bigger Y,
    it is like "T" where to the right still means bigger X, but now down means bigger Y.
    Also called "screen coordinate system" where the beginning is at the top left corner.
 */
